...
namespace LinqToXml.Samples.Sample02
{
    public class LinqQueryViewModel : CommonBase {
        ...
        public void GetAll() {
            ...
            XElement doc = XElement.Load(AppSettings.Instance.CustomersFile);

            // Get All Customers
            IEnumerable<XElement> orders = from order in doc.Elements("Customer")
                                           select order;
        ...
        public void GetAllUsingXDocument() {
            StringBuilder sb = new StringBuilder(1024);
            XDocument doc = XDocument.Load(AppSettings.Instance.CustomersFile);

            // Get All Sales Order Headers
            IEnumerable<XElement> orders = from order in doc.Descendants("Customer")
                                           select order;
        ...
        public void SingleNode() {
            ...
            XElement customer = (from cust in doc.Elements("Customer")
        ...
        public void WhereClause() {
            StringBuilder sb = new StringBuilder(1024);
            XElement doc = XElement.Load(AppSettings.Instance.SalesOrderHeadersFile);

            // Get Sales Order Headers by CustomerID
            IEnumerable<XElement> orders = from order in doc.Elements("SalesOrderHeader")
        ...
        public void WhereClauseUsingAttribute() {
            XElement doc = XElement.Load(AppSettings.Instance.CustomersAttributesFile);
        ...
        public void OrderBy() {
            ...
            IEnumerable<XElement> customers = from cust in doc.Elements("Customer")
        ...
        public void Join() {
            ...
            XElement newDoc = new XElement("SalesOrderWithCustomerInfo",
        ...
        public void ReadConfig() {
            StringBuilder sb = new StringBuilder(1024);
            XElement doc = XElement.Load(AppDomain.CurrentDomain.SetupInformation.ConfigurationFile);

            // Find <appSettings> element and get all <add> elements
            IEnumerable<XElement> settings = (from setting in doc.Elements("appSettings").Elements("add")
                                              select setting);
        ...
        public void LoadClasses() {
            ...
            List<Customer> customers = (from cust in doc.Elements("Customer")
                                        orderby cust.Element("CompanyName").Value
                                        select new Customer {
